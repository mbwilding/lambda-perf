...
After all these invocations, all information stored in DynamoDB is aggregated and a new JSON file is created, then committed to this repo. ie: https://github.com/maxday/lambda-perf/blob/main/data/2022-09-05.json
